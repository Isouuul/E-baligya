  ...
  <Text style={{
    ...
    {order.status}
        ...
        <TouchableOpacity
          ...
          style={[styles.cancelButton, { marginHorizontal: 15, marginBottom: 30, borderRadius: 8, paddingVertical: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: isCancelling ? '#FCA5A5' : '#EF4444' }]}
